...
void CargaDatos::cargarDatos() {
    ...
    set5.insert(TipoLibreta::AutoProfesional);
    set5.insert(TipoLibreta::MotoAmateur);
    ...
    // // Vehiculos de greg_m
    cu.registrarVehiculo("greg_m", "LDA4875", 1, "Honda", "CB Twist", TipoVehiculo::Moto);
    ...
    // Viaje 1
    DTFecha fecha1 = DTFecha(21, 10, 2026);
